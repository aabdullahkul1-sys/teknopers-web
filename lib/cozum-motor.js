...
function cozumFoto(sektor){
  ...
  if(/diş|dis|klinik|diyet|veteriner|fizyo|sağlık|saglik|pilates|estetik|cilt/.test(s)){ img='klinik-diyetisyen-randevu'; alt='Kliniğinde tablette hasta randevularını yöneten uzman — TeknoPers randevu'; }
  else if(/kuaför|kuafor|güzellik|guzellik|berber|salon|spa|masaj|dövme|dovme|tırnak|tirnak/.test(s)){ img='kuafor-salon-randevu-yonetimi'; alt='Salon sahibi tablet ile randevuları yönetiyor — TeknoPersSalon'; }
