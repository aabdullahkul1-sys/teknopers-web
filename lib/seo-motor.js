...
function NAV(){
  return '<header class="mast"><div class="mast-in">'+
    '<a class="wordmark" href="/">TEKNOPERS</a>'+
    '<nav class="mast-nav">'+
      ...
      '<a class="wa" href="https://wa.me/'+WA+'?text='+WA_METIN+'" target="_blank" rel="noopener">WhatsApp</a>'+
    '</nav>'+
  '</div></header>';
}
...
var STIL = [
":root{--paper:#FBF9F2;--bg:#F3EFE6;--cream:#F3EFE6;--ink:#12294A;--ink2:#1B3557;--slate:#55607A;--mut:#6A6656;--line:#E6DFCE;--line2:#D8CFB8;--gold:#C6A23A;--goldD:#8A6A12;--goldL:#F3E9C9;--green:#1E7A48;--greenL:#E6F1E8;--navy:#0E2140;--disp:'Sora','Segoe UI',system-ui,-apple-system,Arial,sans-serif;--body:'Figtree','Segoe UI',system-ui,-apple-system,Arial,sans-serif;--mono:'JetBrains Mono',ui-monospace,Consolas,monospace;--r:10px;--sh:0 10px 30px rgba(14,33,64,.10)}",
...
"header.mast{position:sticky;top:0;z-index:100;background:var(--bg);border-bottom:1px solid var(--line)}",
".mast-in{max-width:1140px;margin:0 auto;padding:16px 22px 12px;display:flex;align-items:flex-end;justify-content:space-between;gap:18px;flex-wrap:wrap}",
".wordmark{position:relative;font-family:var(--disp);font-weight:800;font-size:20px;letter-spacing:.16em;text-transform:uppercase;color:var(--ink);padding-bottom:11px;display:inline-block}",
".wordmark::after{content:'';position:absolute;left:0;bottom:0;width:46px;height:4px;background:var(--gold)}",
".mast-nav{display:flex;align-items:center;gap:20px;font-size:14px;font-weight:600;color:var(--slate);padding-bottom:5px;flex-wrap:wrap}",
".mast-nav a:hover{color:var(--ink)}.mast-nav a.wa{color:var(--green);font-weight:700}",
"@media(max-width:720px){.mast-nav{gap:13px;font-size:12.5px;width:100%}}",
".btn{display:inline-flex;align-items:center;justify-content:center;gap:8px;font-family:var(--body);font-weight:700;font-size:15px;padding:13px 22px;border-radius:8px;border:1px solid transparent;cursor:pointer;line-height:1.3;text-decoration:none;transition:background .15s}",
".btn-gold{background:var(--gold);color:var(--navy)}.btn-gold:hover{background:#B4922F}",
".btn-navy{background:var(--navy);color:var(--cream)}.btn-navy:hover{background:#152C52}",
".btn-wa{background:var(--green);color:#fff}.btn-wa:hover{background:#186339}",
...
".eyebrow{font-family:var(--mono);font-size:11px;font-weight:700;letter-spacing:.18em;text-transform:uppercase;color:var(--goldD);display:inline-flex;align-items:center;gap:10px;margin-bottom:16px}.eyebrow::before{content:'';width:28px;height:3px;background:var(--gold)}",
"h1{font-family:var(--disp);font-size:clamp(27px,4.6vw,38px);font-weight:800;line-height:1.16;letter-spacing:-.012em;margin:0 0 20px;color:var(--ink)}",
"h1::after{content:'';display:block;width:54px;height:4px;background:var(--gold);margin-top:18px}",
"article h2{font-family:var(--disp);font-size:21px;font-weight:700;margin:28px 0 10px;color:var(--ink);position:relative;padding-left:16px}article h2::before{content:'';position:absolute;left:0;top:5px;bottom:5px;width:4px;background:var(--gold);border-radius:2px}",
...
".uyari{margin:22px 0;padding:13px 16px;background:var(--goldL);border-left:3px solid var(--gold);border-radius:0 8px 8px 0;font-size:13.5px;line-height:1.6;color:#5C4B14}.uyari a{color:var(--goldD);font-weight:600}",
".arac-cta{margin:28px 0;padding:20px;border-radius:10px;background:var(--paper);border:1px solid var(--line);border-left:4px solid var(--gold)}",
...
".ilgili ul{list-style:none;padding:0;margin:0}.ilgili a{display:block;padding:12px 14px;color:var(--ink);border:1px solid var(--line);border-radius:8px;margin-bottom:9px;font-weight:600;background:var(--paper)}.ilgili a:hover{border-color:var(--gold);background:#fff}",
"footer{background:var(--navy);color:#C7CFDD;margin-top:44px;padding:44px 0 26px;font-size:14px}",
...
"footer .logo{position:relative;font-family:var(--disp);font-weight:800;font-size:19px;letter-spacing:.14em;text-transform:uppercase;color:#fff;padding-bottom:10px;display:inline-block}footer .logo::after{content:'';position:absolute;left:0;bottom:0;width:40px;height:4px;background:var(--gold)}footer .logo .lg{display:none}",
"footer h3{font-family:var(--disp);font-size:15px;color:#fff;margin-bottom:12px}",
"footer a{display:block;color:#AAB4C6;padding:4px 0}footer a:hover{color:#fff}",
"footer .social{display:flex;gap:14px;margin-top:14px;flex-wrap:wrap}footer .social a{display:inline;font-weight:600;color:var(--gold)}",
"footer .foot-bottom{display:flex;justify-content:space-between;gap:12px;flex-wrap:wrap;border-top:1px solid rgba(255,255,255,.12);margin-top:28px;padding-top:18px;font-size:13px;color:#8892A6}"
].join("");
