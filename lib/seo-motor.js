...
var MARKA = 'TEKNOPERS';
var WA = '905434472226';
function FUNNEL(demo){ demo=demo||'/demo'; return '<div style="max-width:720px;margin:26px auto;padding:16px 20px;border:1px solid #EAD9A8;border-radius:16px;background:linear-gradient(135deg,#FFF9EC,#FFFDF7);display:flex;flex-wrap:wrap;align-items:center;justify-content:space-between;gap:14px"><div style="min-width:200px;flex:1"><div style="font-weight:800;font-size:15.5px;color:#0B1220;line-height:1.3">Beğendin mi? Gerçeğini gör.</div><div style="font-weight:500;font-size:13px;color:#6B7280;margin-top:3px;line-height:1.5">Canlı demoyu dene; sonra 15 gün ücretsiz + 1 yıl 1.000 ₺ kampanyasına katıl.</div></div><div style="display:flex;gap:9px;flex-wrap:wrap"><a href="'+demo+'" style="display:inline-flex;align-items:center;gap:6px;padding:11px 17px;border-radius:12px;background:#0B1220;color:#fff;font-weight:700;font-size:14px;text-decoration:none">&#9654; Canlı Demo</a><a href="/kampanya" style="display:inline-flex;align-items:center;gap:6px;padding:11px 17px;border-radius:12px;background:linear-gradient(135deg,#E0A100,#B8860B);color:#0B1220;font-weight:800;font-size:14px;text-decoration:none;box-shadow:0 8px 20px rgba(224,161,0,.3)">&#128640; Kampanya &#8594;</a></div></div>'; }
...
function NAV(){
  ...
  return '<a href="/#fiyat" style="display:block;background:linear-gradient(90deg,#0B1220,#1b2942);color:#FFD873;text-align:center;text-decoration:none;font:700 12.5px/1.35 \'JetBrains Mono\',ui-monospace,monospace;letter-spacing:.02em;padding:9px 14px;border-bottom:1px solid #26324a">🚀 Lansman kampanyası: 1 yıl 1.000 ₺ — sınırlı süre · <span style="color:#fff;text-decoration:underline">Detay →</span></a>'+
...
module.exports = { slugYap:slugYap, slugCoz:slugCoz, esc:esc, vurgu:vurgu, sadeMetin:sadeMetin, ozet:ozet, sayfaUret:sayfaUret, hataSayfasi:hataSayfasi, listeSayfasiUret:listeSayfasiUret, FUNNEL:FUNNEL, STIL:STIL, NAV:NAV, FOOTER:FOOTER, ASISTAN:ASISTAN, SITE:SITE, WA:WA, GA_ID:GA_ID };
