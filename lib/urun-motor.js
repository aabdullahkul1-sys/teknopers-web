...
function urunSayfaUret(o, sektorler, sorular){
  ...
  var sektorHtml=(sektorler&&sektorler.length)
    ? '<section class="u-sec"><div class="u-kicker">Sektörel uyarlama</div><h2>Hangi sektörler için?</h2><p>Aynı ürün, sektörünüzün diline uyarlanır.</p><div class="sec-grid">'+
  ...
  // ALT ÖZELLİKLER
  (o.altOzellikler&&o.altOzellikler.length ? '<section class="u-sec"><div class="u-kicker">Ürünün modülleri</div><h2>İçindeki özellikler</h2><p>Bu ürün tek bir işlev değil; ihtiyacınıza göre açılan alt modüller barındırır.</p>'+altOzellikGrid(o.altOzellikler)+'</section>\n' : '')+
  // NEDİR
  '<section class="u-sec"><div class="u-kicker">Tanım</div><h2>'+esc(o.ad)+' nedir?</h2>'+(o.nedir||[]).map(pp).join('')+'</section>\n'+
  // SEKTÖRLER
  sektorHtml+'\n'+
  // EVRİLEBİLİRLİK
  '<section class="evolve"><span class="tag">Modüler & Uyarlanabilir</span><h2>Sisteminiz her yöne evrilir</h2><p>TEKNOPERS sabit bir kalıp değildir. Küçük eklemeler ve çıkarmalarla işinize birebir uyarlanır; bugün ihtiyacınız olan modülle başlar, yarın büyüdüğünüzde yenilerini eklersiniz.</p></section>\n'+
  // FİYAT
  ...
  aracHtml+'\n'+soruHtml+'\n'+
  // FINAL CTA
  '<section class="u-final"><h2>'+esc(o.ctaBaslik||'Başlayalım')+'</h2><p>'+esc(o.ctaMetin||'Demo için bize yazın.')+'</p><div class="u-cta">'+finalCta+'</div></section>\n'+
  '</main>\n'+seo.FOOTER()+'\n'+seo.ASISTAN()+'\n</body>\n</html>';
}
