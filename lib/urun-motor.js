...
function urunSayfaUret(o, sektorler, sorular){
  ...
  '<div class="big">1.000 ₺<small>/ay</small></div>'+
  ...
  '</div><div class="price-rozet">Aylık 1.000 ₺ · 15 gün ücretsiz dene</div>'+
  '<div class="price-note">Lansman kampanyası: aylık 1.000 ₺ (sunucu maliyetine yakın). Normal fiyat üstte gösterilir. KDV hariç · sınırsız personel · kurulum + eğitim + destek dahil.</div>'+
